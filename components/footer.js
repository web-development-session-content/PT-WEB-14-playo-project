...
function footer()
{
    ...
    <div id="div1">
        <div id="weblogo">
            <a href="index.html"><img src="https://web.archive.org/web/20220704055452im_/https://playo-website.gumlet.io/playo-website-v2/logos-icons/playo-Web-Logo.png?auto=compress,format" alt="logo" width="100%" height="100%"></a>
        </div>
        <div id="playstore">
