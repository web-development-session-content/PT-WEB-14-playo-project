...
function footer() {
  return `<div id="infooter">
    <div id="div1">
        <div id="weblogo">
            <a href="index.html"><img src="./images/playo.png"></a>
        </div>
        <div id="playstore">
    ...
    <div id="div4">
        <a href="https://www.facebook.com/PlayoApp/"><p><i class="fa-brands fa-facebook"></i>  Facebook</p></a>
        <a href="https://twitter.com/playoApp"><p><i class="fa-brands fa-twitter"></i>  Twitter</p></a>
        <a href="https://www.instagram.com/playoapp/"><p><i class="fa-brands fa-instagram"></i>Instagram</p></a>
        <a href="https://www.linkedin.com/company/playo"><p><i class="fa-brands fa-linkedin"></i>LinkdIn</p></a>
    </div>
</div>`;
}
