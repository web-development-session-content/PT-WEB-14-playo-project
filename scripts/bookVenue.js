...
document.querySelector("#cname").textContent = name;
...
function fillDates() {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    dayanddate.className = "dayanddate";
    dayanddate.setAttribute("onclick", `selectDay(${i + 1})`);
    ...
    dateElement.className = "dayname";
    dateElement.textContent = date.toLocaleDateString("en-US", {
      day: "numeric",
      month: "short",
    });

    dayanddate.appendChild(dayElement);
    dayanddate.appendChild(dateElement);

    dateandday.appendChild(dayanddate);
  }
}

function selectDay(dayIndex) {
  const allDays = document.querySelectorAll(".dayanddate");
  allDays.forEach((day) => {
    day.style.backgroundColor = "white";
    const dayName = day.querySelector(".dayname");
    dayName.style.color = "black";
  });

  const selectedDay = document.getElementById(`day${dayIndex}`);
  selectedDay.style.backgroundColor = "#4daa0b";

  const dayName = selectedDay.querySelector(".dayname");
  dayName.style.color = "white";

  const date = new Date();
  date.setDate(date.getDate() + (dayIndex - 1));
  const dateElement = selectedDay.querySelector(".dayname");
  dateElement.textContent = date.toLocaleDateString("en-US", {
    day: "numeric",
    month: "short",
  });

  console.log("Selected Day Index:", dayIndex);
}

// Call the function to fill in the dates dynamically
fillDates();
...
// document.getElementById("day5").addEventListener("click", () => {
...
// document.getElementById("day6").addEventListener("click", () => {
...
document.getElementById("btn1").addEventListener("click", () => {
  ...
  sportname.textContent = filter_by;
  ...
  courtimage.src = "https://www.svgrepo.com/download/110867/tennis-court.svg";
  ...
  datecartimg.src = "https://cdn-icons-png.flaticon.com/256/2370/2370264.png";
  ...
  timecartimg.src = "https://www.svgrepo.com/download/38630/clock.svg";
  ...
  costimg.src =
    "https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Indian_Rupee_symbol_in_circle_PD_version.svg/2048px-Indian_Rupee_symbol_in_circle_PD_version.svg.png";
