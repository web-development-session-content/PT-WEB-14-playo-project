...
//     let quoteUrl = "://bodybuilding-quotes1.p.rapidapi.com/random-quote";
//     fetch(quoteUrl, {
// 	"method": "GET",
// 	"headers": {
...
//     //Edit 
//     function fetchNews(){
//     let apiKey_blog = "3327ecf049014ed3a0386592d331e10b";
//     let bloglink = `https://newsapi.org/v2/top-headlines?country=in&category=sports&pageSize=10&apiKey=${apiKey_blog}`;
//     fetch(bloglink)
//     .then((res)=>{
//         return res.json();
...
//         let apiKey_health = "3327ecf049014ed3a0386592d331e10b";
...
//         console.log("test")
//         let search_key = "3327ecf049014ed3a0386592d331e10b";
//         let search_link = `https://newsapi.org/v2/everything?q=${value}&from=2023-08-05&sortBy=popularity&pageSize=10&language=en&apiKey=${search_key}`;
